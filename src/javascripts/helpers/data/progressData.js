...
const progressUpdate = (e) => {
  ...
  if (e.target.type === 'button') {
    ...
    document.querySelector('#progress').innerHTML = `<div class="progress"><div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="${average}" aria-valuemin="0" aria-valuemax="100" style="width: ${average}%"></div></div>`;
